  ...
  <head>
      ...
      <%
            ...
            if((request.getAttribute("dividendo")!=null)&&(request.getAttribute("divisor")!=null)&&(request.getAttribute("ceros")!=null)&&(request.getAttribute("decimalesDivd")!=null)&&(request.getAttribute("decimalesDivs")!=null)&&(request.getParameter("idDivision")!=null)){        
                ...
                int decimalesInt = Integer.parseInt(decimalesDivs);
  ...
  <div id="includedContent"></div>
    ...
    <script> 
        ...
        $(function(){
                ...
                for(var x=0;x<nInputs;x++){
                    ...
                    //inputs+="<div id='cifra"+x+"'>";
                        if((contAuxTab<contadorTabulado)||(contAuxPintar>=solucionActual.length))
                        {
                            ...
                            inputs += "<input type='text' class='form-control' style='visibility:hidden;' onkeypress='return isNumberKeyCociente(event)' maxlength='1' id='oculto"+x+ i +"i'>";
                            if(x<nInputs-1){
                        ...
                        {
                            inputs += "<input type='text' class='form-control' id='paso"+x+ i +"i' onkeypress='return isNumberKeyCociente(event)'  maxlength='1'>";
                            if(x<nInputs-1)
                            {
            ...
            var decimalesDivsInt = <%=decimalesDivs%>;
            var decimalesDivdInt = <%=decimalesDivd%>;
            
            //Recogemos la diferencia para ocultar lo correspondiente
            var decimalesDif = decimalesDivsInt - decimalesDivdInt ;
            
            //Recorremos inversamente para ir ocultando digitos
            for(var i=0;i<decimalesDif;i++){
            ...
            $("#paso" + ((dividendoLength - decimalesDivsInt)-1) + "ds").html('<b>,</b>');
    ...
    function onClickDecimal() {
        ...
        if(comaPos > -1 && comaPos < divs.length - 2){
            ...
            $("#paso" + ((dividendoLength - (totalDivisor - comaPos))-1) + "ds").html('');
            
            $("#paso" + (dividendoLength - (totalDivisor - comaPos)) + "ds").html('<b>,</b>');
...
<div class="panel panel-primary" style="background-color:#337ab7;">
 ...
 <div class="panel panel-primary" style="background-color:#337ab7;">
    <form id="formEnviar" method="GET" action="/ActiLinev1/guardarDivisionDAMN">
