...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <div class="row">
		<div class="col-md-12"><center><img src="<%=constantesClass.urlRaiz%>images/confirmation.png" height="200" alt="Ejercicio de matemáticas" class="img-thumbnail"><br/><br/>El ejercicio fue enviado correctamente, para realizar un nuevo ejercicio seleccione la opción en el menú superior.</center></div>
	</div>
  </div>
</div>
<div class="panel panel-primary">
