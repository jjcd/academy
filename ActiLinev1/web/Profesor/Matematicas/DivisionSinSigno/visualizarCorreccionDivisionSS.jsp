...
<html lang="en">
  <head>
      ...
      <%
            ...
            if((request.getAttribute("dividendo")!=null)&&(request.getAttribute("divisor")!=null)&&(request.getAttribute("ceros")!=null)&&(request.getAttribute("solucion")!=null)&&(request.getAttribute("cocienteSolUsuario")!=null)&&(request.getAttribute("solucionusuario")!=null)){        
