...
<html lang="en">
  <head>
      ...
      <%
            ...
            if((request.getAttribute("dividendo")!=null)&&(request.getAttribute("divisor")!=null)&&(request.getAttribute("ceros")!=null)&&(request.getAttribute("solucion")!=null)&&(request.getAttribute("cocienteSolUsuario")!=null)&&(request.getAttribute("solucionusuario")!=null)&&(request.getAttribute("decimales")!=null)&&(request.getAttribute("cocienteSolucion")!=null)){        
                dividendo = request.getAttribute("dividendo").toString();
                
                //Recuperar los decimales y preparar su posición
                ...
                cocienteString = request.getAttribute("cocienteSolucion").toString();
