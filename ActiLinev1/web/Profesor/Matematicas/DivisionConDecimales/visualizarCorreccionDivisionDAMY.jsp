...
<html lang="en">
  <head>
      ...
      <%
            ...
            String decimales = "";
            String decimalesDivd = "";//decimalesDivd
            ...
            int dividendoLength = 0;
            
            if((request.getAttribute("dividendo")!=null)&&(request.getAttribute("divisor")!=null)&&(request.getAttribute("ceros")!=null)&&(request.getAttribute("solucion")!=null)&&(request.getAttribute("cocienteSolUsuario")!=null)&&(request.getAttribute("solucionusuario")!=null)&&(request.getAttribute("decimales")!=null)&&(request.getAttribute("decimalesDivd")!=null)&&(request.getAttribute("decimalesDivs")!=null)){        
                ...
                dividendoLength = dividendoChars.length;
                ...
                dividendoOriginal = dividendo.substring(0, dividendo.length() - decimalesDivdInt) + "," + dividendo.substring(dividendo.length() - decimalesDivdInt, dividendo.length());
                divisorOriginal = divisor.substring(0, divisor.length() - decimalesDivsInt) + "," + divisor.substring(divisor.length() - decimalesDivsInt, divisor.length());
                /*
  ...
  <div id="includedContent"></div>
    ...
    <script> 
        ...
        $(function(){
            ...
            var decimalDivdGlobal = <%=decimales%>;
            var dividendoLength = <%=dividendoLength%>;
                        
            $("#paso" + ((dividendoLength - (decimalDivdGlobal+1))) + "ds").html('<b>,</b>');
