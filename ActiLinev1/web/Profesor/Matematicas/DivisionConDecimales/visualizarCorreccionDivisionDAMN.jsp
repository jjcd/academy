  ...
  <head>
    ...
    %>      
      <%
            ...
            if((request.getAttribute("dividendo")!=null)&&(request.getAttribute("divisor")!=null)&&(request.getAttribute("ceros")!=null)&&(request.getAttribute("solucion")!=null)&&(request.getAttribute("cocienteSolUsuario")!=null)&&(request.getAttribute("solucionusuario")!=null)&&(request.getAttribute("decimalesDivd")!=null)&&(request.getAttribute("decimalesDivs")!=null)){        
                ...
                dividendoOriginal = dividendo.substring(0, dividendo.length() - (decimalesDivdInt+(decimalesDivsInt-decimalesDivdInt))) + "," + dividendo.substring(dividendo.length() - (decimalesDivdInt+(decimalesDivsInt-decimalesDivdInt)), dividendo.length());
                
                dividendoOriginal = dividendoOriginal.substring(0, dividendoOriginal.length()-(decimalesDivsInt-decimalesDivdInt));
