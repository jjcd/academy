 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "crearDivisionAmbosIgual", urlPatterns = {"/crearDivisionAmbosIgual"})
public class crearDivisionAmbosIgual extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            String decimales = request.getParameter("decimalesDivd");
		...
		while(cocientes.size()>0){			
            ...
            //Fin zona de cálculo de pasos
                ...
                request.getRequestDispatcher("Alumno/Matematicas/DivisionConDecimalesAmbos/resolverDivisionDecAmbosIgual.jsp")
