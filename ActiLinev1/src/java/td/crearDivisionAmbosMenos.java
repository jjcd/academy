 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "crearDivisionAmbosMenos", urlPatterns = {"/crearDivisionAmbosMenos"})
public class crearDivisionAmbosMenos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            String decimalesDivd = request.getParameter("decimalesDivd");
            String decimalesDivs = request.getParameter("decimalesDivs");
            
            boolean valido = true;
            int dividendoInt=0;
            int divisorInt=0;
            
            //Antes quitar los decimales, convertir a todo entero.
            //(Sustituir la , por vacío)
            divd = divd.replace(",","");
            divs = divs.replace(",","");
            
            int diferenciaDecimales = Integer.parseInt(decimalesDivs) - Integer.parseInt(decimalesDivd);
            
            try{
                
                dividendoInt = (int) (Integer.parseInt(divd)*(Math.pow(10, diferenciaDecimales)));
		...
		while(cocientes.size()>0){			
            ...
            //Fin zona de cálculo de pasos
                ...
                request.setAttribute("dividendo", dividendoInt + "");
                ...
                request.getRequestDispatcher("Alumno/Matematicas/DivisionConDecimalesAmbos/resolverDivisionDecAmbosMenor.jsp")
