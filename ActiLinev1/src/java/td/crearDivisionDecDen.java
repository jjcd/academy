 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "crearDivisionDecDen", urlPatterns = {"/crearDivisionDecDen"})
public class crearDivisionDecDen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            try{
                ...
                numDecimales = Integer.parseInt(decimales);
                dividendoInt = (int) (Integer.parseInt(divd)*(Math.pow(10, numDecimales)));
            }
            catch(Exception ex)
            {
                valido = false;
		...
		while(cocientes.size()>0){			
            ...
            //Fin zona de cálculo de pasos
                ...
                request.setAttribute("divisor", divisorInt+"");
