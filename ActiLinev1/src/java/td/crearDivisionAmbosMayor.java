 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "crearDivisionAmbosMayor", urlPatterns = {"/crearDivisionAmbosMayor"})
public class crearDivisionAmbosMayor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		while(cocientes.size()>0){			
            ...
            //Fin zona de cálculo de pasos
                ...
                request.getRequestDispatcher("Alumno/Matematicas/DivisionConDecimalesAmbos/resolverDivisionDecAmbosMayor.jsp")
