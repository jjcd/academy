 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "crearDivisionDecNum", urlPatterns = {"/crearDivisionDecNum"})
public class crearDivisionDecNum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		while(cocientes.size()>0){			
            ...
            //Fin zona de cálculo de pasos
                ...
                request.getRequestDispatcher("Alumno/Matematicas/DivisionConDecimalNumerador/resolverDivisionDN.jsp")
