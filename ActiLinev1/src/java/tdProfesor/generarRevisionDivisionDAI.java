 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "generarRevisionDivisionDAI", urlPatterns = {"/generarRevisionDivisionDAI"})
public class generarRevisionDivisionDAI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if((request.getParameter("valor")!=null)&&(request.getParameter("solucion")!=null)&&(request.getParameter("solucionusuario")!=null))
        {
            ...
            request.getRequestDispatcher("Profesor/Matematicas/DivisionConDecimales/visualizarCorreccionDivisionDAI.jsp").forward(request, response);
