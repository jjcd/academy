 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "generarRevisionDivisionDAMN", urlPatterns = {"/generarRevisionDivisionDAMN"})
public class generarRevisionDivisionDAMN extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if((request.getParameter("valor")!=null)&&(request.getParameter("solucion")!=null)&&(request.getParameter("solucionusuario")!=null))
        {
            ...
            String decimalesDivd = request.getParameter("solucion").split(":")[3];
            String decimalesDivs = request.getParameter("solucion").split(":")[4];
            ...
            request.getRequestDispatcher("Profesor/Matematicas/DivisionConDecimales/visualizarCorreccionDivisionDAMN.jsp").forward(request, response);
