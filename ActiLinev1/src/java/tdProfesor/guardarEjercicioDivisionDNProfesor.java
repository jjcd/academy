 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "guardarEjercicioDivisionDNProfesor", urlPatterns = {"/guardarEjercicioDivisionDNProfesor"})
public class guardarEjercicioDivisionDNProfesor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            if((dividendo!=null)&&(divisor!=null)&&(!dividendo.equals(""))&&(!divisor.equals(""))&&(!decimales.equals(""))){
                String valor = "División con decimal en numerador: " + dividendo + "/" + divisor;
                String url = constantesClass.urlRaiz + "crearDivisionDecNum?dividendo="+dividendo+"&divisor="+divisor+"&decimales="+decimales;
                String tipoejercicio = "DIVDN";
