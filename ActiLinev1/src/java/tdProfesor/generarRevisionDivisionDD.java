 ...
 * @author JUAN JOSE
 */
@WebServlet(name = "generarRevisionDivisionDD", urlPatterns = {"/generarRevisionDivisionDD"})
public class generarRevisionDivisionDD extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if((request.getParameter("valor")!=null)&&(request.getParameter("solucion")!=null)&&(request.getParameter("solucionusuario")!=null))
        {
            ...
            request.getRequestDispatcher("Profesor/Matematicas/DivisionConDecimales/visualizarCorreccionDivisionDD.jsp").forward(request, response);
